...
class QA(Base):
    id = db.Column(db.Integer, primary_key=True)
    Q_name = db.Column(db.String(128), unique=True, index=True)
    A_name = db.Column(db.String(128), unique=False, index=True)
    topic = db.Column(db.String(128), unique=False, index=True)
    Url = db.Column(db.String(128), unique=False, index=True)
